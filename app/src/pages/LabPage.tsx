  ...
  return (
    ...
    >
      <Link 
        ...
        className="group relative flex flex-col h-full p-6 md:p-8 rounded-[2rem] border transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#F5C518]/5 bg-[#FAFAFA] dark:bg-[#0F0F0F] border-gray-200 dark:border-white/5 hover:border-[#F5C518]/20 dark:hover:border-[#F5C518]/20"
      >
        <div className="flex justify-between items-start mb-6">
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-xl bg-[#F5C518] text-black shadow-lg">
        ...
        <h3 className="text-xl md:text-2xl font-serif font-black mb-4 text-[#1A1A1A] dark:text-white transition-colors leading-tight">
          {experiment.title}
        </h3>
        ...
        <div className="absolute inset-0 bg-[#F5C518]/0 group-hover:bg-[#F5C518]/5 transition-all duration-500 rounded-[2rem]" />
      </Link>
    </motion.div>
  );
};
