...
const JsIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" {...props} fill="currentColor">
    <path d="M3 3h18v18H3V3zm13.3 15.5c1.1 0 2.1 -0.5 2.1 -1.8 0 -1 -0.6 -1.5 -1.7 -1.9l-1.1 -0.5c-0.5 -0.2 -0.7 -0.4 -0.7 -0.7 0 -0.3 0.3 -0.5 0.7 -0.5c0.5 0 0.8 0.2 1 0.5l1.1 -0.7c-0.3 -0.6 -0.9 -1 -1.8 -1c-1.1 0 -2 0.6 -2 1.7 0 1 0.6 1.5 1.7 1.9l1.1 0.5c0.5 0.2 0.7 0.4 0.7 0.7 0 0.4 -0.4 0.6 -0.9 0.6c-0.6 0 -1 -0.3 -1.2 -0.8l-1.2 0.7c0.4 0.9 1 0.1 0.3 2.1 1.1 2.1 1.8z M12.2 13.5v5H13.6v-5h-1.4z" />
  </svg>
);

const HtmlIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" {...props} fill="currentColor">
    <path d="M1.5 0h21l-1.91 21.563L12 24l-8.59-2.437L1.5 0z m7.031 9.75l-0.232 -2.718 10.059 0.003 0.23 -2.622L5.412 4.41l0.698 8.01h9.126l-0.326 3.426-2.91 0.804-2.955 -0.81-0.188 -2.11H6.248l0.33 4.171L12 19.351l5.379 -1.443 0.744 -8.157H8.531z" />
  </svg>
);
...
const CssIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" {...props} fill="currentColor">
    ...
    <path d="M12 4.4l-7.23 -0.01 0.2 2.3h9.84l-0.33 3.42h-6.72l0.2 2.3h6.3l-0.33 3.42-2.91 0.81-2.96 -0.81-0.2 -2.3H5.5l0.33 4.17L12 19.35l5.38 -1.44 0.82 -8.59 0.33 -3.04 0.14 -1.88z" />
  </svg>
);

const GsapIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" {...props} fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M12 2 L2 7 L12 12 L22 7 L12 2 Z M2 17 L12 22 L22 17 M2 12 L12 17 L22 12" />
  </svg>
);
